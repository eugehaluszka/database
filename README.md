...
### ⚙️ The Multi-Stage Filtration Process
...
```text
├── data/
│   ├── geolocation_glossary.csv     # Final consolidated glossary (Appendix A.3)
│   └── initial_dictionary.json      # Predefined dictionary (provinces, abbreviations, top 5 cities)
├── src/                             # (Optional) Data cleaning/filtering scripts
└── README.md
